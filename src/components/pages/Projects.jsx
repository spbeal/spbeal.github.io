...
const Projects = () => {
  return (
    <div>
    <div name='projects' className='bg-universal dark:bg-universal-dark w-full min-h-screen '>
      <Helmet>
        <title>Projects - Samuel</title>
      </Helmet>
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full overflow-auto'>
               ...
               <div className='text-center grid sm:grid-cols-2 md:grid-cols-3 gap-4 pb-8'>
                    ...
                    <StyledContainer className = "content-div shadow-lg shadow-[#040c16]">
                        ...
                        <StyledContent>
                            ...
                            <p className='text-2xl font-semibold'>Fall 2024</p>
